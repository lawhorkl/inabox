...
5. Either (a) or (b). 
5. (a)Load the included schema: `bundle exec rake db:schema:load`
5. (b)Modify the data migrations to your requirements, and then run the migrations to generate a new schema: `bundle exec rake db:migrate`
