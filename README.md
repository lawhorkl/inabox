...
7. Create a new `Server` in the Control Panel that has the API installed on it, you should see the first data point craeted and graphed within the first thirty seconds to a minute.
